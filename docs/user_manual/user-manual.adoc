...
===== *Execute BAPI_MATERIAL_AVAILABILITY RFC flow*

 Call the material availability BAPI function using Enosix SAP framework.

image::/docs/user_manual/image/09_RFC_Flow.png[RFC Call Flow]
image::/docs/user_manual/image/09_RFC_Configuration.png[RFC Call Config]
